...
--                                                                       --
-- Telemetry values must be named "Ptch", "Roll", "FM", "GSpd", "GAlt"	 --
-- Telemetry value can be renamed in the radio telemetry list or if 	 --
-- another name is desired, edit lines 244 - 248 below with your actual	 --
-- pitch, roll, flight mode, speed, and altitude telemetry names.		 --
---------------------------------------------------------------------------
...
local function refresh(widget)
    ...
    local z = widget.zone
--Edit for telemetry name for pitch (Ptch), roll (Roll), flight mode (FM), altitude (GAlt), speed (GSpd)
    local pitch = getValue("Ptch") or 0
    local roll  = getValue("Roll") or 0
    local fm    = getValue("FM") or ""
	local alt	= getValue("GAlt") or 0
...
lcd.drawText(  --GPS Speed display
    cx - 130,
    z.y + 40,
    "MPH",
    CENTER + SMLSIZE
...
lcd.drawText(  --GPS Altitude display
    cx + 130,
    z.y + 40,
    "ALT",
    CENTER + SMLSIZE
